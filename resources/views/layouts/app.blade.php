    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body d-flex justify-content-around">
            <a href="{{ route('post#excel') }}" class="btn btn-success"><i class="fas fa-file-excel"></i> Excel
                (.xlsx)</a>
            ...
            <a href="#" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-file-pdf"></i> PDF
                (.pdf)</a>
            <a href="{{ route('post#csv') }}" class="btn btn-warning text-white"><i class="fas fa-file-csv"></i>
                CSV (.csv)</a>
        </div>
      ...
      <div class="modal-content">
        ...
        <form action="{{ route('post#import') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="modal-body">
              <p class="mb-2 text-muted">Choose .xlsx or .csv file!.</p>
